...
/*package*/ final class RtpH265PayloadReader implements RtpPayloadReader {
    ...
    private static final int NAL_UNIT_TYPE_STAP_A = 48; // Single-Time Aggregation Packet A
    private static final int NAL_UNIT_TYPE_FU_A = 49; // Fragmentation Units A
    ...
    private void handleSingleNalUnit(ParsableByteArray packet) {
        ...
        if (nalUnitType == NAL_UNIT_TYPE_IDR_W_RADL || nalUnitType == NAL_UNIT_TYPE_IDR_N_LP || nalUnitType == NAL_UNIT_TYPE_NON_IDR) {
    ...
    private void handleFragmentationNalUnit(ParsableByteArray packet) {
        ...
        nalHeader[0] = (byte)(nalUnitType << 1);
        nalHeader[1] = 1;
        ...
        if (isFirstFragmentUnit) {
            ...
            fragmentUnit[0] = nalHeader[0];
            fragmentUnit[1] = nalHeader[1];
        ...
        private void consume(int type, ParsableByteArray nalUnit) {
            ...
            switch (nalUnitType) {
                ...
                default:
                    if ((allowNonIdrKeyframes && nalUnitType == NAL_UNIT_TYPE_NON_IDR)
                            || (detectAccessUnits && (nalUnitType == NAL_UNIT_TYPE_IDR_W_RADL
                            || nalUnitType == NAL_UNIT_TYPE_IDR_N_LP
            ...
            if (!hasOutputFormat) {
                if (spsNalUnit != null && ppsNalUnit != null) {
                    ...
                    format = Format.createVideoSampleFormat(formatId, MimeTypes.VIDEO_H265, null,
